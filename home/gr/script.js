...
const achievements = [
    {
       ...
       descriptions: [
            ...
            " • Διαχείριση Κύκλου Ζωής Υλικού: Ενορχήστρωσα την προετοιμασία και την ανάπτυξη 37 τερματικών υψηλών επιδόσεων για χρήση από το προσωπικό/φοιτητές και διαχειρίστηκα τις υπάρχουσες μονάδες στο AD.",
